    ...
    <ReportSectionCard id="market-analysis" title="Market Analysis" defaultOpen>
      ...
      <div className="flex flex-wrap gap-8 py-2">
        {marketData.growth_rate && (
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1">Growth Rate</p>
            <p className="text-sm"><span className="font-mono text-primary font-semibold">{marketData.growth_rate}</span></p>
          </div>
        )}
        {marketData.market_maturity && (
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1">Market Maturity</p>
      ...
      {/* Trends */}
      <div>
        <h3 className="font-sans text-lg font-semibold flex items-center gap-2 mb-3">Market Trends</h3>
      ...
      {safeArray(marketData.barriers).length > 0 && (
        <>
          <div className="border-t border-border/30" />
          <div>
            <h3 className="font-sans text-lg font-semibold flex items-center gap-2 mb-3">Entry Barriers</h3>
        ...
        <>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {safeArray(marketData.market_risks).length > 0 && (
              <div className="bg-red-500/[0.04] rounded-lg p-4">
